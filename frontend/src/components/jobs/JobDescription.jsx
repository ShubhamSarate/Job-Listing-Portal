  ...
  return (
    <div className="max-w-7xl mx-auto my-10">
      <div className="flex items-center justify-between">
        ...
        <Button disabled={isApplied} className='bg-black text-white hover:bg-gray-800 text-[white]'>{isApplied ? "Applied" : "Apply Now"}</Button>
      </div>
      ...
      <div className="my-4">
        ...
        <h1 className="font-bold my-1">Salary : <span className="pl-4 font-normal text-gray-800">3LPA</span></h1>
        <h1 className="font-bold my-1">Total Applicants : <span className="pl-4 font-normal text-gray-800">5</span></h1>
        <h1 className="font-bold my-1">Posted Date : <span className="pl-4 font-normal text-gray-800">23-12-2002</span></h1>
      </div>
    </div>
  );
};
